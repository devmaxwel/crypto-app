           ...
           <div className={classes.sidebar}>
            ...
            <div className={classes.marketData}>
                ...
                <span style={{
                    ...
                    >Current Price: </Typography> 
                       &nbsp;&nbsp;
                        ...
                        >
                            {symbol}{" "}
                            {numberWithComas(coin?.market_data.current_price[currency.toLowerCase()])}
                        </Typography>
                ...
                <span style={{
                    ...
                    variant="h5"
                    className={classes.heading}
                    >Market_Cap: </Typography> &nbsp;&nbsp;
                        <Typography
                        variant="h5"
                        >
                             {symbol}{" "}
                            {numberWithComas(coin?.market_data.market_cap[currency.toLowerCase()].toString().slice(0, -6))}M
                        </Typography>
